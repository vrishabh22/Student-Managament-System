...
<form name="form1" method="post" action="" id="formID">
  ...
  <p>
    ...
    <input type="text" name="coursename" id="textfield2" class="validate[required,custom[onlyLetterSp]] text-input" value="">
  </p>
  <p>
  ...
  <p>
    ...
    <input type="text" name="coursekey" id="coursekey" class="validate[required,custom[onlyLetterSp]] text-input" value="">
  </p>
  <p>
